...
class RecordedSimulation extends Simulation {
	...
	setUp(scn.inject(rampUsers(12000) during (1 minute), rampUsersPerSec(90) to (180) during (2 minutes), rampUsersPerSec(180) to (60) during (2 minutes))).protocols(httpProtocol)
}
