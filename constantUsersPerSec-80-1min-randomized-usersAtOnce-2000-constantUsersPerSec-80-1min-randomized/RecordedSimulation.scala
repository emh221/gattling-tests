...
class RecordedSimulation extends Simulation {
    ...
    setUp(scn.inject(constantUsersPerSec(65) during (1 minute) randomized, atOnceUsers(2000), constantUsersPerSec(80) during (1 minutes) randomized )).protocols(httpProtocol)
