...
class RecordedSimulation extends Simulation {
	...
	setUp(scn.inject(rampUsers(18000) during (1 minute), rampUsersPerSec(90) to (120) during (2 minutes), rampUsersPerSec(100) to (60) during (1 minute))).protocols(httpProtocol)
}
