...
class RecordedSimulation extends Simulation {
	...
	setUp(scn.inject(rampUsers(18000) during (1 minute), rampUsersPerSec(70) to (100) during (2 minutes), rampUsersPerSec(120) to (60) during (1 minute))).protocols(httpProtocol)
}
