...
class RecordedSimulation extends Simulation {
	...
	setUp(scn.inject(rampUsers(3000) during (30 seconds), rampUsersPerSec(30) to (50) during (1 minute), rampUsersPerSec(20) to (80) during (1 minute))).protocols(httpProtocol)
}
